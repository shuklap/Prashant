(select 'NO TAGS' as with_tags, buys.period_start_date as day, states.abbreviation,
...
AND buys.period_start_date between '20120801' AND now() 
...
(select 'WITH TAGS' as with_tags, buys.period_start_date as day, states.abbreviation,
buyers.party, issues_relations.category as category, 
